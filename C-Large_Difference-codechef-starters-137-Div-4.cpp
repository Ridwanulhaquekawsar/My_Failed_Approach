...
void solve(){
    ...
    f(n){
        if(i == 0 || i == n - 1){
            // for 1 :
            x = abs(v[i] - v[i - 1]);
            (i == 0) ? y = abs(1 - v[i + 1]) : y = abs(1 - v[i - 1]);
            ...
            // for k :
            (i == 0) ? y = abs(k - v[i + 1]) : y = abs(k - v[i - 1]);
            ...
            // for 1 : 
            x = abs(v[i] - v[i - 1]) + abs(v[i] - v[i + 1]);
            y = abs(1 - v[i - 1]) + abs(1 - v[i + 1]);
